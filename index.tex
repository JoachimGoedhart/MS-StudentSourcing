...
\hypersetup{
  ...
  pdfkeywords={Crowdsourcing, Dashboard},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{abstract}
Data that is acquired by students as part of a course is often lost.
This is a pity as it is a great opportunity to collect large amounts of
data. Here, we present methods to collect, aggregate and re-use data
that is collect by students in a practical course on cell biology.
Several use-cases are discussed that illustrate how data can be re-used
eihter in teaching or scientific experimentation. A positive side-effect
is that the students learn that their data is valuable.
\end{abstract}

\section*{Plain Language Summary}
Data acquired by students has value and in this work we present several
ways to collect and re-use that data.
...
Source:
\href{https://JoachimGoedhart.github.io/MS-StudentSourcing/index.qmd.html}{Article
Notebook}}
...
since 2017 Source:
\href{https://JoachimGoedhart.github.io/MS-StudentSourcing/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
